<x-app-layout>
    ...
    <div class="py-12 bg-amber-50/40 min-h-screen">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            @if (session('success'))
                <div class="mb-4 p-4 text-sm text-amber-950 bg-amber-100/80 rounded-lg border border-amber-200" role="alert">
                    {{ session('success') }}
                </div>
            @endif
                    ...
                    @endif
                        ...
                        <tr class="group flex flex-col md:table-row mb-5 md:mb-0 border-t-4 border-amber-600 md:border-t-0 border-b border-amber-100/60 md:border-b-0 bg-white md:bg-transparent rounded-2xl md:rounded-none m-4 md:m-0 shadow-sm md:shadow-none hover:shadow-md md:hover:shadow-none md:hover:bg-amber-50/40 transition-all duration-200 overflow-hidden">
                            ...
                            <div class="block md:contents">
                                ...
                                <td class="px-5 py-2 md:px-6 md:py-4 .block md:table-cell border-t border-gray-50 md:border-t-0 inline-block w-1/2 md:w-auto">
                                ...
                                <td class="px-5 py-2 md:px-6 md:py-4 .block md:table-cell inline-block w-1/2 md:w-auto">
                            ...
                            <td class="px-5 py-3 md:px-6 md:py-4 whitespace-nowrap text-xs font-medium md:align-middle bg-gray-50/50 md:bg-transparent flex md:table-cell justify-between border-t border-gray-100 md:border-t-0">
                                <div class="flex items-center space-x-2 w-full md:w-auto justify-end">
                                    ...
                                    <a href="{{ route('productos.edit', $producto->id) }}" class="flex-1 md:flex-none inline-flex items-center justify-center px-3 py-2 bg-white text-gray-700 hover:text-amber-700 hover:bg-amber-50 rounded-lg border border-gray-200 hover:border-amber-200 shadow-sm transition-all duration-150">
                                    ...
                                    <form action="{{ route('productos.destroy', $producto->id) }}" method="POST" onsubmit="return confirm('¿Estás seguro de eliminar este producto?')" class="flex-1 md:flex-none inline-block">
                                        @csrf
                                        @method('DELETE')
                                        <button type="submit" class="w-full inline-flex items-center justify-center px-3 py-2 bg-white text-red-600 hover:bg-red-50 rounded-lg border border-gray-200 hover:border-red-200 shadow-sm transition-all duration-150">
