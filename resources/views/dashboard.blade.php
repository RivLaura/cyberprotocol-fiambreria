        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-gradient-to-r from-amber-800 to-amber-950 p-6 rounded-xl shadow-lg mb-6">
                <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                    <div>
                        <h1 class="font-serif text-2xl text-amber-50 leading-tight tracking-wide">
                            {{ __('Punto de Venta') }}
                        </h1>
                        <p class="text-amber-200/70 text-xs mt-1">Seleccione los productos para comenzar una nueva venta.</p>
                    </div>
                </div>
            </div>
