<x-app-layout>
     ...
     <div class="py-12 bg-amber-50/40 min-h-screen">
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
          ...
          <div class="bg-white overflow-hidden rounded-2xl border border-amber-100 shadow-md">
            ...
            <span class="md:hidden font-sans font-bold text-gray-400 mr-2"></span>{{ $categoria->id }}</td>
    ...
    <div class="flex items-center">
        ...
        <td class="px-6 py-3 md:py-4 whitespace-nowrap text-xs font-medium md:align-middle flex justify-end md:table-cell mt-2 md:mt-0 border-t border-dashed border-amber-100 md:border-t-0 pt-3 md:pt-4">

            <div class="flex items-center justify-start md:justify-end space-x-2 w-full">
                        <div class="px-6 py-4 bg-gray-50/80 border-t border-gray-100 flex justify-end space-x-2 text-xs font-semibold">

                            <a href="{{ route('categorias.index', $categoria->id) }}" class="inline-flex items-center px-3.5 py-2 bg-white text-gray-700 hover:text-amber-700 hover:bg-amber-50 rounded-lg border border-gray-200 hover:border-amber-200 shadow-sm transition-all">

                              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-4 h-4 inline mr-1"><path stroke-linecap="round" stroke-linejoin="round" d="m16.862 4.487 1.687-1.688a1.875 1.875 0 1 1 2.652 2.652L10.582 16.07a4.5 4.5 0 0 1-1.897 1.13L6 18l.8-2.685a4.5 4.5 0 0 1 1.13-1.897l8.932-8.931Zm0 0L19.5 7.125M18 14v4.75A2.25 2.25 0 0 1 15.75 21H5.25A2.25 2.25 0 0 1 3 18.75V8.25A2.25 2.25 0 0 1 5.25 6H10"/>
                              </svg>
                                Ver Detalles 
                ...
                @empty
                    ...
                    <div class="col-span-full bg-white rounded-2xl p-16 text-center border-2 border-dashed border-amber-200 shadow-inner">
                        ...
                        <h3 class="font-serif text-lg font-bold text-amber-950">No hay categorias nuevas</h3>

                        <p class="mt-1 text-sm text-amber-800/60 max-w-sm mx-auto">Comienza agregando productos (como Quesos o Embutidos) para verlas listadas aquí.</p>
